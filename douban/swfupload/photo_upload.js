...
function fileQueued(c) {
	var a = this,
	b = new FileProgress(c, a.customSettings.progressTarget);
	totalNum += 1;
	totalSize += c.size;
...
//alert(c);
	var b = new FileProgress(e, this.customSettings.progressTarget),
	...
	function() {
		$.post_withck(a.customSettings.jUrl + "deletephoto", {
			page_id: a.customSettings.subjectId,
...
function uploadError(c, e, d) {
	var a = this,
	b = new FileProgress(c, this.customSettings.progressTarget);
	b.setError();
	b.toggleCancel(true, a);
	allErrorFiles++;
